...
import { useStyles } from '../School/FooterStyles'
  ...
  return (
      <div className={classes.container}>
          ...
          <div className={classes.styleFlex}>
              ...
              <a href="https://es-la.facebook.com" target='_blank' rel="noreferrer" className={classes.a_Redes}>
          ...
          <div className={classes.styleFlex}>
              ...
              <a href="https://www.instagram.com" target='_blank' rel="noreferrer" className={classes.a_Redes}>
